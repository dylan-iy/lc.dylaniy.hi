...
**IMPORTANT**: SET ESTUARY TEMPO TO 100 (`!setbpm 100`) BEFORE RUNNING CODE 

## 2/22 6:37a
Took time to familiarize myself with the basic concepts of minitidal and implementation in  in estuary terminal. Picked a percussion loop to recreate ([1:49 of We're Dumb by salami rose joe louis](https://tidalcycles.org/docs/reference/cycles)).
